...
namespace Perforce.P4
{
	...
	public class Fix
	{
		...
		public void ParseFixesCmdTaggedData(TaggedObject obj)
		{
			...
			{
				Date = FormBase.ConvertUnixTime(obj["Date"]);
			}
		...
		public static Fix FromFixesCmdTaggedOutput(TaggedObject obj)
		{
			Fix val = new Fix();
			val.ParseFixesCmdTaggedData(obj);
			return val;
		}
