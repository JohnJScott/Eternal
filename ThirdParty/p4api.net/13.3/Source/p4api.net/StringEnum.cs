...
namespace Perforce.P4
{
	...
	internal class StringEnum<T> // where T : IComparable<T>
	{
		...
		//		public enum Case {None, Lower, Upper};
	...
	internal class StringEnumList<T> : IList<T>
	{
		...
		//public static implicit operator IList<T>(StringEnumList<T> l) { return l; }
		//public static implicit operator StringEnumList<T>(IList<T> l)
		//{
		//    return new StringEnumList<T>(l);
		//}
