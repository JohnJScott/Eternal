...
namespace p4api.net.unit.test
{
	...
	public class FileSpecTest
	{
		...
		/// <summary>
		///A test for FileSpec Constructor
		///commented out
		///</summary>
		//[TestMethod()]
		//public void FileSpecConstructorTest()
		//{
		//    PathSpec path = null; // TODO: Initialize to an appropriate value
		//    VersionSpec version = null; // TODO: Initialize to an appropriate value
