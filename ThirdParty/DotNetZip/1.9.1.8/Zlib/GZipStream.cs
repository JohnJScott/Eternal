...
namespace Ionic.Zlib
{
	...
	public class GZipStream : Stream
	{
		...
		public virtual long TotalIn
		{
			get
			{
				return _baseStream.Codec.TotalBytesIn;
			}
		}
		...
		public virtual long TotalOut
		{
			get
			{
				return _baseStream.Codec.TotalBytesOut;
			}
		}
		...
		public override long Position
		{
			get
			{
				...
				{
					return _baseStream.Codec.TotalBytesOut + _headerByteCount;
				}
				if( _baseStream._streamMode == ZlibBaseStream.StreamMode.Reader )
				{
					return _baseStream.Codec.TotalBytesIn + _baseStream._gzipHeaderByteCount;
				}
				return 0;
			}
