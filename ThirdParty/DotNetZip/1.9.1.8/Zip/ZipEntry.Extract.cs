...
namespace Ionic.Zip
{
	public partial class ZipEntry
	{
		...
		internal CrcCalculatorStream InternalOpenReader( string password )
		{
			...
			Int64 LeftToRead = ( _CompressionMethod_FromZipFile == ( short )CompressionMethod.None ) ? _CompressedFileDataSize : UncompressedSize;
		...
		internal void VerifyCrcAfterExtract( Int32 actualCrc32 )
		{
			...
			if( actualCrc32 != _Crc32 )
			{
				...
				if( ( Encryption != EncryptionAlgorithm.WinZipAes128 && Encryption != EncryptionAlgorithm.WinZipAes256 ) || _WinZipAesMethod != 0x02 )
				{
		...
		private Int32 ExtractOne( Stream output )
		{
			...
			try
			{
				...
				Int64 LeftToRead = ( _CompressionMethod_FromZipFile != ( short )CompressionMethod.None ) ? UncompressedSize : _CompressedFileDataSize;
...
#if AESCRYPTO
				Encryption != EncryptionAlgorithm.WinZipAes128 && Encryption != EncryptionAlgorithm.WinZipAes256 &&
#endif
