...
namespace Ionic.Zip
{
	partial class ZipFile
	{
		...
		private void _AddOrUpdateSelectedFiles( string selectionCriteria, string directoryOnDisk, string directoryPathInArchive, bool recurseDirectories, bool wantUpdate )
		{
			...
			FileSelector ff = new FileSelector( selectionCriteria, AddDirectoryWillTraverseReparsePoints );
		...
		{
			ICollection<ZipEntry> selection = SelectEntries( selectionCriteria );
		...
		{
			ICollection<ZipEntry> selection = SelectEntries( selectionCriteria, directoryPathInArchive );
			RemoveEntries( selection );
			return selection.Count;
		}
...
namespace Ionic
{
	...
	internal partial class SizeCriterion : SelectionCriterion
	{
		internal override bool Evaluate( ZipEntry entry )
		{
			return Evaluate( entry.UncompressedSize );
		}
	}
	...
	public partial class FileSelector
	{
		...
		{
			bool result = Criterion.Evaluate( entry );
			return result;
		}
