		...
		, IDisposable
	{
		...
		protected override void Dispose( bool disposing )
		{
			if( !_closed )
			{
				...
				if( disposing ) 
				{
					// When ZipInputStream is used within a using clause, and an exception is thrown, Close() is invoked.  But we don't want to
					// try to write anything in that case.  Eventually the exception will be propagated to the application.
