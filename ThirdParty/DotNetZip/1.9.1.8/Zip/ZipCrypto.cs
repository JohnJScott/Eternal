...
namespace Ionic.Zip
{
	...
	internal class ZipCrypto
	{
		...
		{
			Encoding IBM437Encoding = Encoding.GetEncoding( "IBM437" );
			byte[] p = IBM437Encoding.GetBytes( passphrase );
		...
		{
			_Keys[0] = ( UInt32 )crc32.ComputeCrc32( _Keys[0], byteValue );
