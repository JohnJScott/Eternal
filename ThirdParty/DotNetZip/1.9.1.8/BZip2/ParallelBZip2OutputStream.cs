...
namespace Ionic.BZip2
{
	...
	public class ParallelBZip2OutputStream 
		: Stream
	{
		private static readonly int BufferPairsPerCore = 4;
		private readonly int blockSize100k; // 0...9
		private readonly object eLock = new object(); // for exceptions
		private readonly object latestLock = new object();
		private readonly bool leaveOpen;
		private readonly object outputLock = new object(); // for multi-thread output
		...
		private void FlushOutput( bool lastInput )
		{
			...
			{
				WorkItem workitem = pool[currentlyFilling];
			...
			do
			{
				...
				do
				{
					if( Monitor.TryEnter( toWrite, millisecondsToWait ) )
					{
						...
						if( nextToWrite >= 0 )
						{
							WorkItem workitem = pool[nextToWrite];
